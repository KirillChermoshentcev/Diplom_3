...
class TestPersonalAccountPage:
    ...
    def test_go_to_personal_acc_page(self, driver, registration_new_user_and_delete):
    ...
    def test_go_to_order_history_page(self, driver, registration_new_user_and_delete):
        main_page = MainPage(driver)
        main_page.wait_visibility_title_of_page()
        main_page.click_on_personal_acc_button()
        account_page = AccountPage(driver)
    ...
    def test_logout(self, driver, registration_new_user_and_delete):
        main_page = MainPage(driver)
        main_page.wait_visibility_title_of_page()
        main_page.click_on_personal_acc_button()
        account_page = AccountPage(driver)
